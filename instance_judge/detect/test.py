...
def detect(save_img=False,file_path=None):
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', nargs='+', type=str,
                        default='./runs/detect/best.pt',
                        help='model.pt path(s)')
    parser.add_argument('--source', type=str, default=file_path,
...
def get_frame():
    ...
    result = detect(file_path=file_name)
    return result
